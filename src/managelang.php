    ...
    <div class="btn-group" dropdown is-open="status.isopen">
       ...
       <center>
        ...
        <input id='filesVal' value='{{ selected_lang.files }}' type='hidden'>
            ...
            <A href="./languages.php" class="btn btn-primary" id="deletelang"><span class="glyphicon glyphicon-hand-left" aria-hidden="true"></span> <B>Back</B></A>
                <button id="save_langs" class="btn btn-danger" name="trythispatterns" data-loading-text="Loading..."><span class="glyphicon glyphicon-floppy-open" aria-hidden="true"></span> <B>Save</B> </button> <select id="select" multiple="multiple">
<?php
    $stack1 = array();
    $stack2 = array();
