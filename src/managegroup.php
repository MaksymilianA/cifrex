    ...
    <div class="btn-group" dropdown is-open="status.isopen">
       ...
       <center>
        ...
        <input id='filesVal' value='{{ selected_group.files }}' type='hidden'>
                ...
                <A href="./groups.php" class="btn btn-primary"><span class="glyphicon glyphicon-hand-left" aria-hidden="true"></span> <B>Back</B></A>

                <button id="save_groups" class="btn btn-danger" name="trythispatterns" data-loading-text="Loading..."><FONT COLOR=white><span class="glyphicon glyphicon-floppy-open" aria-hidden="true"></span> <B>Save</B></font> </button> <select id="select" multiple="multiple">
<?php
    $stack2 = array();
...
?>
            ...
            <button id="show_selected" class="btn btn-primary" name="trythispatterns" data-loading-text="Loading..." type="button"><span class="glyphicon glyphicon-sunglasses" aria-hidden="true"></span> <B>Show selected</B></button>
    </div>
